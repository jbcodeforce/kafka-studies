...
public class OrderCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private acme.eda.demo.ordermgr.infra.events.Address shippingAddress;
   ...
   */
  public OrderCreatedEvent(java.lang.String orderID, java.lang.String productID, java.lang.String customerID, java.lang.Integer quantity, java.lang.String status, acme.eda.demo.ordermgr.infra.events.Address shippingAddress) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: shippingAddress = (acme.eda.demo.ordermgr.infra.events.Address)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public acme.eda.demo.ordermgr.infra.events.Address getShippingAddress() {
   ...
   * @param value the value to set.
   */
  public void setShippingAddress(acme.eda.demo.ordermgr.infra.events.Address value) {
   ...
   */
  public static acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder newBuilder() {
    return new acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder();
  }
   ...
   * @return A new OrderCreatedEvent RecordBuilder
   */
  public static acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder newBuilder(acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder other) {
    if (other == null) {
      return new acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder();
    } else {
      return new acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderCreatedEvent RecordBuilder
   */
  public static acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder newBuilder(acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent other) {
    if (other == null) {
      return new acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder();
    } else {
      return new acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCreatedEvent>
    ...
    /** Address to ship the ordered items */
    private acme.eda.demo.ordermgr.infra.events.Address shippingAddress;
    private acme.eda.demo.ordermgr.infra.events.Address.Builder shippingAddressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder other) {
      super(other);
      ...
      if (other.hasShippingAddressBuilder()) {
        this.shippingAddressBuilder = acme.eda.demo.ordermgr.infra.events.Address.newBuilder(other.getShippingAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderID)) {
        this.orderID = data().deepCopy(fields()[0].schema(), other.orderID);
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder setOrderID(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder clearOrderID() {
      orderID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder setProductID(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder clearProductID() {
      productID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder setCustomerID(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder clearCustomerID() {
      customerID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder setStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder setShippingAddress(acme.eda.demo.ordermgr.infra.events.Address value) {
     ...
     * @return This builder.
     */
    public acme.eda.demo.ordermgr.infra.events.Address.Builder getShippingAddressBuilder() {
      if (shippingAddressBuilder == null) {
        if (hasShippingAddress()) {
          setShippingAddressBuilder(acme.eda.demo.ordermgr.infra.events.Address.newBuilder(shippingAddress));
        } else {
          setShippingAddressBuilder(acme.eda.demo.ordermgr.infra.events.Address.newBuilder());
        }
      }
    ...
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder setShippingAddressBuilder(acme.eda.demo.ordermgr.infra.events.Address.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public acme.eda.demo.ordermgr.infra.events.OrderCreatedEvent.Builder clearShippingAddress() {
    ...
    public OrderCreatedEvent build() {
      try {
        ...
        if (shippingAddressBuilder != null) {
          ...
          record.shippingAddress = fieldSetFlags()[5] ? this.shippingAddress : (acme.eda.demo.ordermgr.infra.events.Address) defaultValue(fields()[5]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.shippingAddress == null) {
        this.shippingAddress = new acme.eda.demo.ordermgr.infra.events.Address();
      }
