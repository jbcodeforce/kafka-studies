package acme.eda.demo.ordermgr.infra.kafka;
...
public class KafkaConfiguration {
    ...
    @ConfigProperty(name = "kafka.value.serializer", defaultValue = "acme.eda.demo.ordermgr.infra.events.OrderEventSerializer")
